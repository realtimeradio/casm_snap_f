...
function fft_12i_8192pt_18i18o_core_config(this_block)
  ...
  this_block.setEntityName('fft_12i_8192pt_18i18o_core_ip_struct');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('in0').width ~= 18);
      this_block.setError('Input data type for port "_in0" must have width=18.');
    end
    if (this_block.port('in1').width ~= 18);
      this_block.setError('Input data type for port "_in1" must have width=18.');
    end
    if (this_block.port('in2').width ~= 18);
      this_block.setError('Input data type for port "_in2" must have width=18.');
    end
    if (this_block.port('in3').width ~= 18);
      this_block.setError('Input data type for port "_in3" must have width=18.');
    end
    if (this_block.port('in4').width ~= 18);
      this_block.setError('Input data type for port "_in4" must have width=18.');
    end
    if (this_block.port('in5').width ~= 18);
      this_block.setError('Input data type for port "_in5" must have width=18.');
    end
    if (this_block.port('in6').width ~= 18);
      this_block.setError('Input data type for port "_in6" must have width=18.');
    end
    if (this_block.port('in7').width ~= 18);
      this_block.setError('Input data type for port "_in7" must have width=18.');
    end
    if (this_block.port('in8').width ~= 18);
      this_block.setError('Input data type for port "_in8" must have width=18.');
    end
    if (this_block.port('in9').width ~= 18);
      this_block.setError('Input data type for port "_in9" must have width=18.');
    end
    if (this_block.port('in10').width ~= 18);
      this_block.setError('Input data type for port "_in10" must have width=18.');
    end
    if (this_block.port('in11').width ~= 18);
      this_block.setError('Input data type for port "_in11" must have width=18.');
    end
